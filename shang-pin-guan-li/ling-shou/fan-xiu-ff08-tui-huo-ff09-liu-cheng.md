...
点击【选择客户】，后系统弹出选择客户对话框，输入关键字，点击【搜索】，选择需要返修的客户。![](/assets/cjlsd-2.png)\*1、此处的会员就是客户管理中的客户（参考【[客户](/ke-hu.md)】）。
...
点击【生成返修单】，系统自动跳转到创建返修单页面，根据实际情况，填写返修原因，点击【保存】![](/assets/cjlsfxd-10.png)

接下来的操作与【[手动创建返修单](#sdcjlsd)】一样，请参考

———————————————————————————

对应的零售订单将记录该退货单，并且订单状态为【已退货】如下图：![](/assets/cjlsfxd-11.png)
